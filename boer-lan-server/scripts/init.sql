...
CREATE TABLE IF NOT EXISTS production_records (
    ...
    pattern_no BIGINT UNSIGNED DEFAULT 0,
    pattern_name VARCHAR(255),
    protocol_user_id VARCHAR(50),
    ...
    start_time DATETIME,
    end_time DATETIME,
    start_needle BIGINT UNSIGNED DEFAULT 0,
    end_needle BIGINT UNSIGNED DEFAULT 0,
    stop_reason BIGINT UNSIGNED DEFAULT 0,
    ...
    INDEX idx_employee_id (employee_id),
    INDEX idx_pattern_id (pattern_id),
    INDEX idx_pattern_no (pattern_no),
    INDEX idx_protocol_user_id (protocol_user_id),
...
CREATE TABLE IF NOT EXISTS salary_records (
    ...
    pattern_name VARCHAR(255),
    order_no VARCHAR(100),
    source_production_id BIGINT UNSIGNED,
    pieces INT DEFAULT 0,
    unit_price DOUBLE DEFAULT 0,
    ...
    INDEX idx_pattern_id (pattern_id),
    INDEX idx_order_no (order_no),
    UNIQUE KEY uk_source_production_id (source_production_id),
    INDEX idx_record_date (record_date),
    INDEX idx_deleted_at (deleted_at)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
