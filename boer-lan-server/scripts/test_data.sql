...
-- 设备数据 (20台设备)
-- ========================================
INSERT INTO devices (id, code, name, type, model, ip, status, group_id, last_online, created_at) VALUES
-- A车间-1号线 (5台)
...
SELECT 'device_groups' AS table_name, COUNT(*) AS count FROM device_groups
UNION ALL
