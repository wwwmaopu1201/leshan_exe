...
func SetupRouter(r *gin.Engine, db *gorm.DB, jwtSecret string, jwtExpire int, serverPort int, patternTransfer *service.PatternTransferService, connMgr *service.ConnectionManager) {
	...
	protected.Use(EnsureActiveAccount(db))
	{
		...
		protected.GET("/device/types", permDevice, deviceHandler.GetDeviceTypes)
		protected.POST("/device/type-summary", permDevice, deviceHandler.CreateDeviceType)
		protected.GET("/device/type-summary", permDevice, deviceHandler.GetDeviceTypeSummary)
		protected.PUT("/device/type-summary", permDevice, deviceHandler.RenameDeviceType)
		protected.DELETE("/device/type-summary", permDevice, deviceHandler.DeleteDeviceType)
		protected.GET("/device/electric-control-types", permDevice, deviceHandler.GetElectricControlTypes)
		protected.POST("/device/electric-control-type-summary", permDevice, deviceHandler.CreateElectricControlType)
		protected.GET("/device/electric-control-type-summary", permDevice, deviceHandler.GetElectricControlTypeSummary)
		protected.PUT("/device/electric-control-type-summary", permDevice, deviceHandler.RenameElectricControlType)
		protected.DELETE("/device/electric-control-type-summary", permDevice, deviceHandler.DeleteElectricControlType)
		...
		protected.GET("/pattern/files/download", permPatternFiles, patternHandler.DownloadPatternFiles)
